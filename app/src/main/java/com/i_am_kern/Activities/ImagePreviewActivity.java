...
import com.i_am_kern.Adapter.ImagePreviewAdapter;
...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.lzy.ninegrid.R.layout.activity_preview);

        ViewPager viewPager = (ViewPager) findViewById(com.lzy.ninegrid.R.id.viewPager);
        final TextView tv_pager = (TextView) findViewById(com.lzy.ninegrid.R.id.tv_pager);
        rootView = (RelativeLayout) findViewById(com.lzy.ninegrid.R.id.rootView);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                tv_pager.setText(String.format(getString(com.lzy.ninegrid.R.string.select), currentItem + 1, imageInfo.size()));
            }
        });
        tv_pager.setText(String.format(getString(com.lzy.ninegrid.R.string.select), currentItem + 1, imageInfo.size()));
    }
