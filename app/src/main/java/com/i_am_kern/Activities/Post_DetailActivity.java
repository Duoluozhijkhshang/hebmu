...
import com.i_am_kern.Activities.ImagePreviewActivity;
    ...
    private class Myadpter extends BaseQuickAdapter<Comment,BaseViewHolder>{
        ...
        protected void convert(BaseViewHolder helper, Comment item) {
            if (helper.getAdapterPosition()==0){
                helper.setText(R.id.postdetail_item_luoceng,"楼主");
            }else {
            ...
            nineGridView.setAdapter(new NineGridViewClickAdapter(getApplicationContext(),imageInfo) {
                ...
                protected void onImageItemClick(Context context, NineGridView nineGridView, int index, List<ImageInfo> imageInfo) {
                    ...
                    Intent intent = new Intent(context, com.i_am_kern.Activities.ImagePreviewActivity.class);
